...
osSemaphoreId spi_rx_sem;
osSemaphoreDef(spi_rx_sem);

osSemaphoreId spi_tx_sem;
osSemaphoreDef(spi_tx_sem);

osSemaphoreId cmddata_rdy_rising_sem;
...
// HAL Callback for EXTI1_IRQHandler (interrupt context).
