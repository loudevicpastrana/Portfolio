...
class Adafruit_FT6206 {
 ...
 private:
  ...
  void Init();
  int32_t I2CWrite(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length);
  int32_t I2CRead(uint16_t DevAddr, uint16_t Reg, uint8_t *pData, uint16_t Length);
};
